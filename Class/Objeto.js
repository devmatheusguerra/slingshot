class Objeto {
  constructor ({ width, height, velocidade }) {
    ...
    this.object.setAttribute('id', 'projetil')
    ...
    css.innerHTML = `
        ...
        .rotate {
            ...
            animation: rotate ${
              velocidade != undefined ? 25 / velocidade : 25 / 10
            }s linear infinite;
        }
        `
  ...
  setPosition ({ x, y }) {
    if (x != undefined) this.object.style.left = x + 'px'
    if (y != undefined) this.object.style.bottom = y + 'px'
  }
